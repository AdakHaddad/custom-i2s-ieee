...
The design is vendor-agnostic at the audio-clock level because BCLK and WS (and optionally MCLK) are synthesized digitally from a single 100\,MHz system clock rather than from dedicated PLL audio outputs.
